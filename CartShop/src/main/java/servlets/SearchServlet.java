...
public class SearchServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ProductService service = (ProductService) MyApplicationContext.getMyContext().getAttribute("ProductService");
        List<Product> products = service.find(request.getParameter("query"));
